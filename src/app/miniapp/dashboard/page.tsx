  ...
  return (
    <div className="flex flex-col gap-4 px-4 pt-5 pb-6">
      ...
      <div className="flex gap-1 rounded-full bg-muted p-1">
        <button onClick={() => setView('actual')} className={cn('flex-1 rounded-full py-1.5 text-xs font-medium transition-colors', view === 'actual' ? 'bg-background text-foreground shadow-sm' : 'text-muted-foreground')}>
          Лог
        </button>
