...
→ Якщо питають "що я їв", "скільки калорій", "мої звички", "insight about me" — відповідай що можеш переглянути записи через функцію пошуку, і запропонуй перефразувати питання
